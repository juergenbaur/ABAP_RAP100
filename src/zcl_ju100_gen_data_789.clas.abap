CLASS zcl_ju100_gen_data_789 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_JU100_GEN_DATA_789 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '789',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zju100_atrav789.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zju100_atrav789  FROM (
        SELECT
